...
#Write a program that will add all the values between 200 and 2700 (inclusively) that 
# are divisible by 3 or 5, but not both 3 and 5. 
...
#  For this algorithm, build the complete T diagram for the word ‘kayak’.
...
#  For this algorithm, build the complete T diagram for the array [1,-2,3].
